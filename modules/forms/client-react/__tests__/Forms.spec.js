...
describe('Class FormErrors works', () => {
  ...
  step('Class FormErrors works with graphQLErrors', () => {
  ...
  step('Class FormErrors works with other errors', () => {
    const errors = new FormErrors(messageForAlertForm, noGraphQLErrors).errors;
