...
class PaginationModule extends ServerModule[UserContext, SchemaInitializer[_]] {
  ...
  lazy val itemSchemaInitializer: ItemSchemaInitializer =
    inject[ItemSchemaInitializer]

  override lazy val slickSchemas: mutable.HashSet[SchemaInitializer[_]] =
    mutable.HashSet(itemSchemaInitializer)
  override lazy val queries: mutable.HashSet[Field[UserContext, Unit]] =
    mutable.HashSet(itemSchema.queries: _*)
