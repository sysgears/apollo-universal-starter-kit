...
import model.{Item, PaginatedResult, Pagination, PaginationUtil}
import slick.ast.BaseTypedType
import slick.jdbc.JdbcProfile

import scala.concurrent.ExecutionContext

class ItemRepository @Inject()(override val driver: JdbcProfile)(implicit executionContext: ExecutionContext) extends Repository[Item, Int](driver) with PaginationUtil {
