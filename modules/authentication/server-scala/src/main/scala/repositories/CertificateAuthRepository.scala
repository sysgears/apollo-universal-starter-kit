...
class CertificateAuthRepository @Inject()(override val driver: JdbcProfile)
                                         (implicit executionContext: ExecutionContext) extends Repository[CertificateAuth, Int](driver) {
  import driver.api._
