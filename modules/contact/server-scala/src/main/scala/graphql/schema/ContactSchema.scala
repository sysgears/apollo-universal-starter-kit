...
class ContactSchema @Inject()(contactResolver: ContactResolver)
  ...
  implicit val contactInputUnmarshaller: FromInput[Contact] =
  ...
  implicit val contactPayload: ObjectType[UserContext, ContactPayload] =
    deriveObjectType(ObjectTypeName("ContactPayload"))
