...
If you want to develop your web application using Angular instead of React, you need to enable building the Angular 
application and disable the React application. 

Also note that both Angular and React applications run on the same port; therefore, if you run both applications at the 
same time, only one application (most likely, the React application) will be actually running.
