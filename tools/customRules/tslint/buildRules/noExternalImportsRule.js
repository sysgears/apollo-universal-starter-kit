...
var NoExternalImportsWalker = /** @class */ (function (_super) {
     ...
     * @param relatedModule
     */
    NoExternalImportsWalker.prototype.getDependencies = function (providedPath, moduleDependencies, nodeModuleDependencies) {
    ...
    NoExternalImportsWalker.prototype.checkDependenciesInNodeModules = function (currentFolderPath, nodeModuleDependencies, subModuleDependencies, packageJsonDependencies) {
    ...
    NoExternalImportsWalker.prototype.collectNodeModulesDependencies = function (currentPath, nodeModuleDependencies, subModuleDependencies, packageJsonDependencies, nested) {
        ...
        for (var _i = 0, nodeModulesFolders_1 = nodeModulesFolders; _i < nodeModulesFolders_1.length; _i++) {
            ...
            if (packageJsonDependencies.has(moduleFolder)) {
                ...
                if (stat.isSymbolicLink()) {
                    this.getDependenciesFromPackageJson(path.join(currentPath, moduleFolder, 'package.json'), nodeModuleDependencies);
                    continue;
                }
            }
            if (subModuleDependencies[moduleFolder]) {
                if (stat.isDirectory()) {
                    this.collectNodeModulesDependencies(path.join(currentPath, moduleFolder), nodeModuleDependencies, subModuleDependencies, packageJsonDependencies);
                    continue;
                }
            }
     ...
     */
    NoExternalImportsWalker.prototype.getDependenciesFromPackageJson = function (packageJsonPath, moduleDependencies, subModuleDependencies) {
        var _this = this;
     ...
     */
    NoExternalImportsWalker.prototype.addDependencies = function (moduleDependencies, dependencies, moduleSubDependencies) {
