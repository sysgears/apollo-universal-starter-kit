...
const forgotPassword = async ({ body: input }, res) => {
  try {
...
const restApi = [
  { route: '/register', controller: register, method: 'POST' },
  { route: '/login', controller: login, method: 'POST' },
  { route: '/forgotPassword', controller: forgotPassword, method: 'POST' },
  { route: '/resetPassword', controller: resetPassword, method: 'POST' }
];
